...
export default function SecureWalletPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-slate-100 font-sans selection:bg-blue-500/30 selection:text-white py-12 px-4 sm:px-6">
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-xs font-semibold text-slate-400 hover:text-white transition-colors px-3 py-1.5 rounded-lg bg-[var(--card-bg)] border border-[var(--card-border)]"
          >
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2">
          ...
          <p className="text-slate-400 text-xs sm:text-sm">
            Attach external wallets to your QFS Ledger.
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {filteredWallets.map((wallet, i) => (
              <button
                ...
                className="flex flex-col items-center p-4 bg-[var(--background)] border border-[var(--card-border)] rounded-xl hover:border-blue-500 transition-all text-center group"
              >
